...
parser.add_argument('-i','--input-file', type=str, required=False, default="/home/tstuttard/g-2/gm2Dev_v6_02_00_StuttardMDC/data/trajectoryPlots.root", help='Input ROOT file containing plots from StuttardTrajectorySanityPlots module', dest='inputFile')

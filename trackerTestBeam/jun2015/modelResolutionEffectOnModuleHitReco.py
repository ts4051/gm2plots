...
#Define structs
Pos = collections.namedtuple('Pos', 'y z')
...
for i in xrange(0,nev,1):    
  ...
  hitPos = Pos( y=gauss(0.,3.) , z=gauss(0.,3.) )

  #Get ioschrone lines from hit pos
  for i_us in range(0,2) : ##Loop over U view straws
    isochroneLine = Line( m=strawGradient , c=hitPos.y-(strawGradient*hitPos.x) )
    print isochroneLine
